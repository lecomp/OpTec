...
class Usuarios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('IdUsuario, usuario, clave, usrNombre, email, sql_name', 'required'),
			...
			array('IdUsuario, usuario, clave, baja, permisoweb, usrNombre, NivelAcceso, email, port_winsock, sql_name, sql_pass', 'safe', 'on'=>'search'),
		);
	}
